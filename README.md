...
#### 5. How do we get the server to print the string received from the client?
...
#### 6.  We need it to print the string quickly. What changes the duration of the printing?
...
#### 7. How can the server receive strings from several clients in a row without restarting?
